...
#Region "frmPpal Load"
    ...
    Private Sub frmPpal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '                             "configurarInicio". Se ejecuta cuando se inicia y cuando se carga
        '                             un nuevo file.
        '------------------------------------------------------------------------------------------------------------------------
        ...
        '                                                                       el modulo "modDeclaraciones". El soporte esta 
        '                                                                       definido en("c:\cpacad2\mhcadt\")
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.VdF.BaseControl.ActiveDocument.CommandAction.CmdBox3d("USER", "USER", "USER", "USER", "USER")
